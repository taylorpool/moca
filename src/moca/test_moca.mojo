...
fn test_mat_mat_multiply() raises:
    print("# test_mat_mat_multiply")
...
fn test_matT_mat_multiply() raises:
    print("# test_matT_mat_multiply")
    ...
    let C = mc.matT_mat_multiply(A, B)
...
fn test_mat_matT_multiply() raises:
    print("# test_mat_matT_multiply")
    var A = Tensor[DType.float64](1, 2)
    A[Index(0, 0)] = 1.0
    A[Index(0, 1)] = 2.0
    ...
    let C = mc.mat_matT_multiply(A, B)
    _ = assert_equal(C.shape()[0], A.shape()[0])
...
fn test_mat_vec_multiply() raises:
    print("# test_mat_vec_multiply")
...
fn test_matT_vec_multiply() raises:
    print("# test_matT_vec_multiply")
    ...
    let b = mc.matT_vec_multiply(A, x)
...
fn test_matT_vec_multiply2() raises:
    print("# test_matT_vec_multiply")
    ...
    var x = SIMD[DType.float64, 4](7, 8, 9, 10)
...
fn test_vecT_vec_multiply() raises:
    print("# test_vecT_vec")
    let x = mc.arange(4)

    let xtx = mc.vecT_vec_multiply(x, x)
    _ = assert_equal(xtx, 1 + 4 + 9)


fn test_vec_vecT_multiply() raises:
    print("# test_vec_vecT")
    let x = mc.arange(4)

    let xxt = mc.vec_vecT_multiply(x, x)
...
fn test_vecT_mat_vec_multiply() raises:
    ...
    let result = mc.vecT_mat_vec_multiply(x, A, y)
...
fn main() raises:
    ...
    _ = test_multiply()
    _ = test_multiply2()
    _ = test_mat_mat_multiply()
    _ = test_matT_mat_multiply()
    _ = test_mat_matT_multiply()
    _ = test_mat_vec_multiply()
    _ = test_matT_vec_multiply()
    _ = test_matT_vec_multiply2()
    _ = test_vecT_vec_multiply()
    _ = test_vec_vecT_multiply()
    _ = test_vecT_mat_vec_multiply()
